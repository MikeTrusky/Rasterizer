...
{
public:
	Light(float3 position, float3 ambient, float3 diffuse, float3 specular, float shine) : position(position), ambient(ambient), diffuse(diffuse), specular(specular), shine(shine) { };
